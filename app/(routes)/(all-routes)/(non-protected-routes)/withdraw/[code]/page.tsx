...
import { BankService, MainService } from "@/src/services";
    ...
    return (
        <div className="verify-withdrawal-page">
            ...
            {((!isSuccess) && (!error)) ? (
                ...
                <div className="verify-withdrawal">
                    <div className="verify-withdrawal__icon">
                        {(isSuccess) && (
