...
import { InputPassword, InputText, LanguageSelectCompnt, InputCheckbox } from "@/src/components";
...
const page = ({ params }: any) => {
    ...
    structure: [
      {
        ...
        defaultValue: params?.["affiliate-code"],
  ...
  useEffect(() => {
    localStorage.setItem("affiliate-code", `${params?.["affiliate-code"]}`);
    push(Routes.home.href);
  }, [params?.["affiliate-code"]]);
